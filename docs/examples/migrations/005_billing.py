"""Create billing tables — consolidated domain migration

Merges legacy: 008 (subscription_plans + subscriptions + webhook_events + teams alter)
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_webhook_events_stripe_event_id", "webhook_events", ["stripe_event_id"]
    )
    ...
    op.execute(
        ...
        INSERT INTO subscription_plans
            (id, name, slug, amount, currency, interval, features, limits, is_active, display_order)
        VALUES (
