...
| Epic | Scope | Status |
|---|---|---|
| **E277** | **Agent brain** — reconceive `/athena:dba`→drizzle-kit & `/athena:audit`→Drizzle/Zod/UI drift; de-stale 8 agents + 7 commands. (Dead-stack skills removed ✅ PR #21) | 🔄 skills done; reconceive ⬜ |
