...
Size: S (~1 session) | M (1-2 sessions) | L (2-3 sessions) - lives in the `size:` header of each epic file (S/M/L), not this matrix (no Size column here); used by flow/batch model tiering.
