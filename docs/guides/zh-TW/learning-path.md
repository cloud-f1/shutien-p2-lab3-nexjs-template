...
| # | 指南 | 難度 | 預估時間 | 說明 |
|---|------|------|---------|------|
| 1 | [快速上手](quickstart.md) | 入門 | 10 分鐘 | 複製、安裝、用 `make go` 啟動開發環境 |
| 2 | [第一個 Epic 實戰](first-epic-walkthrough.md) | 入門 | 30 分鐘 | 使用 Epic Pipeline 從頭到尾建立完整 Domain |
...
- [TECHSTACK.md](../../../TECHSTACK.md) — 完整技術架構
- [EPIC_INDEX.md](../../epics/EPIC_INDEX.md) — 所有 Epic 的開發進度
